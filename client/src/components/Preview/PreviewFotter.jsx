...
const Fotter = ({previewContent}) => {
    return (
        <section id="project" className="mx-4 flex flex-col items-center justify-center text-white md:mx-48 mt-10 pt-24">
            ...
            <div className='flex justify-evenly w-full'>
                ...
                <div>
                    <a href={previewContent?.githubProfile}><i class="devicon-github-original text-3xl mr-4"></i></a>
                    <a href={previewContent?.linkedinProfile}>
